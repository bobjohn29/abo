...
const updateLiveClock = () => {
  ...
  liveClock.textContent = new Date().toLocaleTimeString("de-DE", {
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit"
  });
...
const revealItems = document.querySelectorAll(
  ".report-card, .pulse-chip, .energy-lead, .energy-card, .showcase-card, .radar-panel, .quote-panel, .sidebar-panel, .stat-chip"
);
